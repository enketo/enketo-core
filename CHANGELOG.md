...
- If a required text input field has a non-whitespace value that is replaced by the user to a white-space-only value the new whitespace-only value is saved in the model and the question is considered valid.
