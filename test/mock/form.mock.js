'use strict';
/**
 * These (except dataEdit strings) should all be replaced by autogenerated model and html form in forms.json
 * This way they stay up to date when the XSL sheet changes!
 */

module.exports = {
    dataEditStr1: '<thedata id="something">' +
        '<meta>' +
    ...
    formStr2: '<form class="or" autocomplete="off" id="random">' +
    ...
    formStr4: '<form class="or" id="nodename_bug">' +
        '<section class="form-logo"> </section>' +
    ...
    formStr5: '<form class="or" id="testPreloads">' +
        '<section class="form-logo"></section>' +
