...
define( [ 'xpath/build/xpathjs_javarosa', 'modernizr', 'jquery', 'bootstrap-datepicker/js/bootstrap-datepicker',
    'bootstrap-timepicker/js/bootstrap-timepicker', 'app/geopoint/geopointpicker', 'app/offline-file/offline-filepicker',
    'app/select/selectpicker', 'app/plugins', 'app/extend'
  ],

  function( XPathJS, modernizr, $ ) {
    "use strict";
    var data, dataToEdit, form, $form, $formClone, repeatsPresent,
      loadErrors = [ ],
      //*** FOR DEBUGGING and UNIT TESTS ONLY ***
      ex = function( expr, type, selector, index ) {
       ...
       *
       */
      init = function( formSelector, dataStr, dataStrToEdit ) {
       ...
       * @param {boolean=} all
       */
      getDataStr = function( incTempl, incNs, all ) {
       ...
       */
      setRecordStatus = function( markedFinal ) {
