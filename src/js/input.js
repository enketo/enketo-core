...
import { getTimezoneOffsetAsTime, toISOLocalString } from 'openrosa-xpath-evaluator/src/date-extensions';
                ...
                switch ( type ) {
                    ...
                    case 'select': {
                        if ( this.isMultiple( control ) ) {
                            ...
                            const option = control.querySelector( `option[value="${CSS.escape( value )}"]` );
                            if ( option ) {
