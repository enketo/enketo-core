...
class AnalogScaleWidget extends RangeWidget {
    ...
    get props() {
        ...
        props.showScale = props.appearances.includes( 'show-scale' );
        ...
        props.step = isNumber( this.element.getAttribute( 'step' ) ) ? this.element.getAttribute( 'step' ) : ( props.showScale ? 10 : 1 ); //( props.type === 'decimal' ? 0.1 : 1 );
